...
public class SalesDAO {
    ...
    public static List<DeliveryVO> getDeliveryInfo(String order_id) {
        SqlSession ss = FactoryService.getFactory().openSession();
        List<DeliveryVO> deliveryInfo = ss.selectList("sales.getDeliveryInfo", order_id);
        ss.close();
