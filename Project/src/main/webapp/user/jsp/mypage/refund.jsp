      ...
      <table id="table">
        ...
        <tr>
          ...
          <tr class="table-child">
            ...
            <td>
              <button id="openModal" class="btn btn-outline-secondary" type="button" onclick="onShowRefundModal()">환불상세</button>
            </td>
            <td>
              <button class="btn btn-outline-secondary" type="button">배송조회</button>
            </td>
            <td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="onHideRefundModal()">닫기</button>
        </div>
      </div>
    </div>
  </div>
