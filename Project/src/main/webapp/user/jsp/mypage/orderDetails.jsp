                    ...
                    <c:if test="${requestScope.o_list ne null and requestScope.vo ne null}">
                        ...
                        <div class="product-section">
                            ...
                            <c:choose>
                                ...
                                <c:when test="${vo.status == '6'}"><p class="payment-status">반품/취소</p></c:when>
                                <c:when test="${vo.status == '7'}"><p class="payment-status">교환</p></c:when>
                            </c:choose>
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="product-price-row">
                                            <p class="product-price">${item.prod_saled_price}원</p>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
                        ...
                        <div class="payment-info">
                            ...
                            <ul class="payment-list">
                                ...
                                <li><span>상품 금액</span> <span class="item-price">${totalPrice}원</span></li>
                                <li><span>할인 금액</span> <span class="discount">-${discountAmount}원</span></li>
                                <li><span>적립금</span> <span class="points-amount">-${pointAmount}원</span></li>
                                ...
                                <li class="total">
                                    ...
                                    <span class="final-price">
                                        ...
                                        <span class="payment-amount">${finalPrice}원</span>
                                    </span>
                                </li>
                                <li><span>결제 수단</span>
                                    <c:choose>
                                        <c:when test="${vo.pay_type == '0'}"><span class="payment-method">무통장입금-[농협]301-1111-2222-3333</span></c:when>
                                        <c:when test="${vo.pay_type == '1'}"><span class="payment-method">계좌이체-[${vo.bank}]${vo.account}</span></c:when>
