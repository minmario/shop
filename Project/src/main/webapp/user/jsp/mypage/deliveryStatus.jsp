                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="info-container">
                                        ...
                                        <button type="button" class="btn btn-outline-dark button">배송조회 FAQ 바로가기</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="info-container">
                                        ...
                                        <button type="button" class="btn btn-outline-dark button">고객센터 FAQ 바로가기</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="info-container">
                                        ...
                                        <button type="button" class="btn btn-outline-dark button">송장 흐름 멈춤 FAQ 바로가기</button>
                                    </div>
                                </div>
                            </div>
                        </div>
