                ...
                <div class="product-details">
                    ...
                    <div class="info-section">
                        <div class="product-info">
                            ...
                            <p><i class="bi bi-dash"></i> 제품번호 <strong>MOTIVESTREET (MILK SST PINK)</strong></p>
                            <p><i class="bi bi-dash"></i> 시즌/성별 <strong>2017 S/S / 여</strong></p>
                            <p><i class="bi bi-dash"></i> 인기도(개수) <strong>2,842 (조회수 82)</strong></p>
                            <p><i class="bi bi-dash"></i> 누적판매 <strong>233개</strong></p>
                            <p><i class="bi bi-dash"></i> 좋아요 <span class="like-count"><i class="bi bi-heart-fill"></i> <strong>91</strong></span></p>
                            <p>
