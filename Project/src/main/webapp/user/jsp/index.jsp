 ...
 <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
     <div class="carousel-inner">
         ...
         <div class="carousel-item active">
             <img src="${pageContext.request.contextPath}/user/images/index1.jpg"  class="d-block w-100" alt="이벤트 이미지 1">
         </div>
         <!-- 두 번째 이미지 -->
         <div class="carousel-item">
             <img src="${pageContext.request.contextPath}/user/images/index2.jpg" class="d-block w-100" alt="이벤트 이미지 2">
         </div>
     ...
     <div class="row row-cols-1 row-cols-md-4 g-4">
         ...
         <div class="col">
             <div class="card h-100">
                 <img src="${pageContext.request.contextPath}/user/images/product1.jpg"  class="card-img-top" alt="Product Image">
                 <div class="card-body">
         ...
         <div class="col">
             <div class="card h-100">
                 <img src="${pageContext.request.contextPath}/user/images/product2.jpg" class="card-img-top" alt="Product Image">
                 <div class="card-body">
         ...
         <div class="col">
             <div class="card h-100">
                 <img src="${pageContext.request.contextPath}/user/images/product3.jpg"  class="card-img-top" alt="Product Image">
                 <div class="card-body">
         ...
         <div class="col">
             <div class="card h-100">
                 <img src="${pageContext.request.contextPath}/user/images/product4.jpg"  class="card-img-top" alt="Product Image">
                 <div class="card-body">
         ...
         <div class="col">
             <div class="card h-100">
                 <img src="${pageContext.request.contextPath}/user/images/product5.jpg"  class="card-img-top" alt="Product Image">
                 <div class="card-body">
         ...
         <div class="col">
             <div class="card h-100">
                 <img src="${pageContext.request.contextPath}/user/images/product6.jpg"  class="card-img-top" alt="Product Image">
                 <div class="card-body">
         ...
         <div class="col">
             <div class="card h-100">
                 <img src="${pageContext.request.contextPath}/user/images/product7.jpg"  class="card-img-top" alt="Product Image">
                 <div class="card-body">
         ...
         <div class="col">
             <div class="card h-100">
                 <img src="${pageContext.request.contextPath}/user/images/product8.jpg"  class="card-img-top" alt="Product Image">
                 <div class="card-body">
