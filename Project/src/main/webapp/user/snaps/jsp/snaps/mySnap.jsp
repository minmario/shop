...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/user/snaps/css/snaps/Mysnap.css">
</head>
</head>
<style>
    /* 프로필 이미지 스타일 */
...
<div class="container-fluid mt-4">
    <div class="row">
        ...
        <div class="col-md-2 border-end position-fixed" style="height: 100vh;">
            <jsp:include page="/user/snaps/jsp/layout/left.jsp"></jsp:include>
        </div>
    ...
    <jsp:include page="/user/snaps/jsp/snaps/snapModal.jsp"></jsp:include>


    <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>


    <script src="${pageContext.request.contextPath}/user/snap/js/snapModal.js"></script>
